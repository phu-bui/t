                            ...
                            <table class="mb-0 table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$product->name}}</td>
                                        <td>{{\App\format_currency($product->cost_price)}}</td>
                                        <td>{{\App\format_currency($product->price)}}</td>
                                        <td>
                                        ...
                                        <td>
                                            <button class="mb-2 mr-2 btn-transition btn btn-outline-success">Chi tiết</button>
                                            <button class="mb-2 mr-2 btn-transition btn btn-outline-primary">Sửa</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
