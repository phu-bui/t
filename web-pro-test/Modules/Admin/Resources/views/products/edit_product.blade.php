                ...
                <form class="form-horizontal" action="{{route('admin.update_product', array('product_id'=>$pro->id))}}" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="product_sku">Mã sản </label>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="long_description">Chi tiết sản phẩm</label>
                            <textarea class="form-control" id="long_description" name="long_description" placeholder={{$pro->long_description}}></textarea>
                        </div>
                        <!-- Input vote -->
                        <div class="col-md-4 mb-3">
                            <label for="image">Bình chọn</label>
                            <input type="text" class="form-control" id="vote" name="vote" value="{{$pro->vote}}" required="">
                        </div>
