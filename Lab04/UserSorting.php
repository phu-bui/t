<?php
    ...
    $values = array('name' => 'Buzz Lightyear', 'email' => 'buzz@starcommand.gal',
        'age' => 32, 'smarts' => 'some');
    $init_values = array(
    'name' => 'Buzz Lightyear',
...
<form action="UserSorting.php" method="post">
    <p>
        ...
        <input type="radio" name="sort_type" value="uasort">User-defined valua sort<br>
    </p>
    <p>
    ...
    <ul>
        <?php
        print("<table><tr><td>Values unsorted (before sort): </td>");
        print("<td>");
        ...
        print("</td><td>");
        if(array_key_exists("submitted", $_POST)){
            print("Values sorted by $sort_type: </td><td>");
