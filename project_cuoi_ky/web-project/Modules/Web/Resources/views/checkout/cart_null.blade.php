                ...
                <div class="max-width-890 mx-auto">
                    <div class="bg-white pt-6 border">
                        ...
                        <div class="border-bottom mb-5 pb-4">
                            ...
                            <br>
                            <button href="{{route('web.remove_order')}}" class="button alt btn btn-dark btn-block rounded-0 py-4" type="submit"><a href="{{route('web.remove_order')}}">Huỷ đơn hàng</a></button>
                        </div>
